...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Master_Detailed_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19Master_Detailed_App11AppDelegate")
...
SWIFT_CLASS("_TtC19Master_Detailed_App20DetailViewController")
...
@interface Event (SWIFT_EXTENSION(Master_Detailed_App))
...
SWIFT_CLASS("_TtC19Master_Detailed_App20MasterViewController")
